...
import java.util.Random;
    ...
    public class Decor
    {
        ...
        private static final int MAXMOVEOBJECT = 200;

        private static final int MAXQUART = 441;

        private static final int SCROLL_SPEED = 8;

        private static final int SCROLL_MARGX = 80;

        private static final int SCROLL_MARGY = 40;

        private static final int BLUPIFLOOR = 2;

        private static final int BLUPIOFFY = 4 + BLUPIFLOOR;

        private static final int BLUPISURF = 12;

        private static final int BLUPISUSPEND = 12;

        private static final int OVERHEIGHT = 80;
        ...
        private ArrayList<ByeByeObject> byeByeObjects;

        public TinyRect DrawBounds() { return m_drawBounds; }
        public void SetDrawBounds(TinyRect value) { m_drawBounds = value; }
        ...
        private void InitDecor()
        {
            ...
            m_moveObject[0].posEnd = m_moveObject[0].posStart.Copy();
            m_moveObject[0].posCurrent = m_moveObject[0].posStart.Copy();
            ...
            m_moveObject[1].posEnd = m_moveObject[1].posStart.Copy();
            m_moveObject[1].posCurrent = m_moveObject[1].posStart.Copy();
        ...
        public void PlayPrepare(boolean bTest)
        {
            ...
            m_blupiPos = m_blupiStartPos.Copy();
            ...
            for (int i = 0; i < MAXMOVEOBJECT; i++)
            {
                ...
                m_moveObject[i].posCurrent = m_moveObject[i].posStart.Copy();
                ...
                {
                    m_moveObject[i].phase = m_random.nextInt(23);
                }
        ...
        private void DrawInfo()
        {
            ...
            if (((int)m_blupiCle & (true ? 1 : 0)) != 0)
            {
                pos.X = 520;
                pos.Y = 418;
                m_pixmap.HudIcon(10, 215, pos);
            }
            if (((int)m_blupiCle & 2) != 0)
            {
                pos.X = 530;
                pos.Y = 418;
                m_pixmap.HudIcon(10, 222, pos);
            }
            if (((int)m_blupiCle & 4) != 0)
            {
                pos.X = 540;
                pos.Y = 418;
        ...
        private TinyPoint DecorNextAction()
        {
            ...
            TinyPoint posDecor = m_posDecor.Copy();
        ...
        private void GetBlupiInfo(boolean bHelico, boolean bJeep, boolean bSkate, boolean bNage)
        {
        ...
        private void AdaptMotorVehicleSound()
        {
            ...
            {
                TinyPoint blupiPos = m_blupiPos.Copy();
        ...
        public void CheatAction(Tables.CheatCodes cheat)
        {
            ...
            if (cheat == Tables.CheatCodes.CleanAll)
            {
                for (int i = 0; i < MAXMOVEOBJECT; i++)
                {
                    if (m_moveObject[i].type == 2 || m_moveObject[i].type == 3 || m_moveObject[i].type == 96 || m_moveObject[i].type == 97 || m_moveObject[i].type == 4 || m_moveObject[i].type == 16 || m_moveObject[i].type == 17 || m_moveObject[i].type == 20 || m_moveObject[i].type == 44 || m_moveObject[i].type == 54 || m_moveObject[i].type == 32 || m_moveObject[i].type == 33)
                    {
                        ...
                        m_moveObject[i].posStart = m_moveObject[i].posCurrent.Copy();
                        m_moveObject[i].posEnd = m_moveObject[i].posCurrent.Copy();
            ...
            if (cheat == Tables.CheatCodes.EndGoal)
            {
                for (int i = 0; i < MAXMOVEOBJECT; i++)
                {
                    ...
                    m_blupiPos = m_moveObject[i].posCurrent.Copy();
            ...
            if (cheat == Tables.CheatCodes.RoundShield)
            {
                ...
                m_blupiPosMagic = m_blupiPos.Copy();
        ...
        {
            TinyPoint celSwitch = new TinyPoint();
            TinyPoint celBridge = new TinyPoint();
            BlupiAdjust();
            m_blupiLastPos = m_blupiPos.Copy();
            TinyPoint end = m_blupiPos.Copy();
            ...
            if (!m_blupiNage && !m_blupiSurf && !m_blupiSuspend && !m_blupiAir && IsRessort(end))
            {
                ...
                if (((int)m_keyPress & (true ? 1 : 0)) != 0 && m_blupiFocus)
                {
            ...
            if (((int)m_keyPress & (true ? 1 : 0)) != 0 && !m_blupiHelico && !m_blupiOver && !m_blupiBalloon && !m_blupiEcrase && !m_blupiJeep && !m_blupiTank && !m_blupiNage && !m_blupiSurf && !m_blupiSuspend && m_blupiFocus)
            {
            ...
            {
                if (((int)m_keyPress & 2) != 0 && m_blupiTimeFire == 0 && m_blupiAction != 3 && m_blupiAction != 58 && flag2)
                {
                    if (m_blupiBullet == 0)
                    {
                ...
                if (Def.EasyMove)
                {
                    if (m_blupiSpeedY <= -1.0 || ((int)m_keyPress & (true ? 1 : 0)) != 0)
                    {
            ...
            if (m_blupiOver && (m_blupiFocus || m_blupiAction == 58))
            {
                ...
                if ((m_blupiSpeedY < 0.0 || ((int)m_keyPress & (true ? 1 : 0)) != 0) && !flag4)
                {
                    if (m_blupiVitesseY == 0.0 && icon != -1)
                    {
                        m_blupiVitesseY = -5.0;
            ...
            {
                if (m_blupiSpeedY < 0.0 || ((int)m_keyPress & (true ? 1 : 0)) != 0)
                {
            ...
            if (m_blupiTank && m_blupiFocus)
            {
                ...
                if (((int)m_keyPress & 2) != 0 && m_blupiTimeFire == 0 && m_blupiAction != 3)
                {
                    if (m_blupiBullet == 0)
                    {
                        PlaySound(53, m_blupiPos);
            ...
            if (m_blupiSuspend && m_blupiFocus)
            {
                ...
                if ((((int)m_keyPress & (true ? 1 : 0)) != 0 || m_blupiSpeedY < 0.0) && m_blupiAction != 4 && m_blupiAction != 3)
                {
                    m_blupiAction = 4;
                    m_blupiPhase = 0;
                }
            ...
            if (m_blupiPower && Math.abs(m_blupiPos.X - m_blupiPosMagic.X) + Math.abs(m_blupiPos.Y - m_blupiPosMagic.Y) >= 40)
            {
                ...
                if (icon != -1)
                {
                    ...
                    m_moveObject[icon].posCurrent = m_blupiPos.Copy();
                    m_moveObject[icon].posStart = m_moveObject[icon].posCurrent.Copy();
                    m_moveObject[icon].posEnd = m_moveObject[icon].posCurrent.Copy();
            ...
            if (!m_blupiHelico && !m_blupiOver && !m_blupiBalloon && !m_blupiEcrase && !m_blupiJeep && !m_blupiTank && !m_blupiSkate && m_blupiFocus)
            {
                ...
                if ((m_blupiSurf || m_blupiNage) && (m_blupiPos.Y % 64 == 64 - BLUPISURF || m_blupiPos.Y % 64 == 32) && IsOutWater(tinyPoint) && ((int)m_keyPress & (true ? 1 : 0)) != 0)
                {
                    m_blupiNage = false;
                    m_blupiSurf = false;
                    m_blupiAir = true;
            ...
            {
                TinyPoint newpos = new TinyPoint();
                if (SearchTeleporte(m_blupiPos, newpos))
                {
                    m_blupiPos = newpos.Copy();
            ...
            if ((m_blupiAction == 11 && m_blupiPhase == 70) || (m_blupiAction == 75 && m_blupiPhase == 100) || (m_blupiAction == 76 && m_blupiPhase == 70) || (m_blupiAction == 77 && m_blupiPhase == 110) || (m_blupiAction == 78 && m_blupiPhase == 90) || (m_blupiAction == 79 && m_blupiPhase == 90) || (m_blupiAction == 80 && m_blupiPhase == 90) || (m_blupiAction == 81 && m_blupiPhase == 90) || (m_blupiAction == 24 && m_blupiPhase == 90) || (m_blupiAction == 54 && m_blupiPhase == 100) || (m_blupiAction == 57 && m_blupiPhase == 90))
            {
                if (m_nbVies > 0)
                {
                    ...
                    if (m_blupiRestart)
                    {
                        m_blupiPos = m_blupiValidPos.Copy();
                    }
        ...
        private void BlupiDead(int action1, int action2)
        {
            ...
            {
                m_blupiAction = ((m_random.nextInt(Integer.MAX_VALUE) % 2 == 0) ? action1 : action2);
            }
            m_blupiPhase = 0;
            m_blupiFocus = false;
            m_blupiHelico = false;
        ...
        private boolean TestPath(TinyRect rect, TinyPoint start, TinyPoint end)
        {
            ...
            TinyPoint tinyPoint = start.Copy();
        ...
        private void MoveObjectBlup(TinyPoint pos)
        {
            ...
            if (num > 0)
            {
                ...
                if (num2 != -1)
                {
                    ...
                    m_moveObject[num2].posStart = m_moveObject[num2].posCurrent.Copy();
        ...
        private int ObjectStart(TinyPoint pos, int type, int speed)
        {
            ...
            m_moveObject[num].posCurrent = pos.Copy();
            m_moveObject[num].posStart = pos.Copy();
            m_moveObject[num].posEnd = pos.Copy();
            ...
            if (speed != 0)
            {
                ...
                {
                    m_moveObject[num].posEnd = tinyPoint.Copy();
        ...
        private void MoveObjectStep()
        {
            ...
            for (int i = 0; i < MAXMOVEOBJECT; i++)
            {
                ...
                if (m_moveObject[i].type == 4 || m_moveObject[i].type == 33 || m_moveObject[i].type == 32)
                {
                    ...
                    if (num != -1)
                    {
                        TinyPoint posCurrent = m_moveObject[i].posCurrent.Copy();
                        posCurrent.X -= 34;
                        posCurrent.Y -= 34;
                        ...
                        m_decorAction = 1;
                        m_decorPhase = 0;
                        posCurrent = m_moveObject[i].posCurrent.Copy();
                        posCurrent.X += 2;
        ...
        private void MoveObjectStepLine(int i)
        {
            ...
            if (m_blupiFocus && !m_blupiHide && m_moveObject[i].type == 97)
            {
                ...
                {
                    m_moveObject[i].posCurrent = end.Copy();
                    m_moveObject[i].posStart = end.Copy();
                    m_moveObject[i].posEnd = end.Copy();
                }
                else
                {
                    ObjectDelete(m_moveObject[i].posCurrent, m_moveObject[i].type);
        ...
        {
            TinyPoint posStart = m_moveObject[i].posStart.Copy();
            posStart.X -= 34;
            posStart.Y -= 34;
            posStart.X += dx;
            posStart.Y -= dy;
                    ...
                    if (Misc.IntersectRect(dst, src2, src))
                    {
                        if (m_moveObject[i].type == 12)
                        {
                            ...
                            for (int l = 0; l < m_nbLinkCaisse; l++)
                            {
                                ...
                                double num = m_random.nextInt(16) + 7;
                                if (m_random.nextInt(100) + 0 % 2 == 0)
                                {
                                    num = 0.0 - num;
                                }
        ...
        private void SearchLinkCaisse(int rank, boolean bPop)
        {
            m_nbLinkCaisse = 0;
            AddLinkCaisse(rank);
            TinyPoint posCurrent = m_moveObject[rank].posCurrent.Copy();
            boolean flag;
            TinyRect src = new TinyRect();
            TinyRect src2 = new TinyRect();
            do
        ...
        private void ByeByeAdd(int channel, int icon, TinyPoint pos, double rotationSpeed, double animationSpeed)
        {
            ...
            int num = m_random.nextInt(10) + 0;
            if (m_random.nextInt(1000) + 0 % 2 == 0)
            {
        ...
        private void AdaptMidBorder(int x, int y)
        {
            ...
            for (int i = 0; i < 144; i++)
            {
                if (num2 == Tables.table_adapt_decor[i])
                {
                    ...
                    if (num2 == 35 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 156;
                    }
                    if (num2 == 251)
                    {
                        num2 = m_random.nextInt(2) + 251;
                    }
                    if (num2 == 254 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 255;
                    }
                    if (num2 == 347 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 362;
                    }
                    if (num2 == 348 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 363;
                    }
                    if (num2 == 341)
                    {
                        num2 = m_random.nextInt(5) + 341;
                    }
            ...
            switch (m_decor[x][y].icon)
            {
                ...
                case 282:
                    ...
                    if (num2 == 268 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 279;
                    }
                    if (num2 == 269 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 280;
                    }
                    if (num2 == 264 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 281;
                    }
                    if (num2 == 265 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 282;
                    }
                    m_decor[x][y].icon = num2;
            ...
            switch (m_decor[x][y].icon)
            {
                ...
                case 303:
                    ...
                    if (num2 == 289 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 300;
                    }
                    if (num2 == 285 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 302;
                    }
                    if (num2 == 286 && m_random.nextInt(Integer.MAX_VALUE) % 2 == 0)
                    {
                        num2 = 303;
                    }
                    m_decor[x][y].icon = num2;
        ...
        public boolean CurrentRead()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                for (int j = 0; j < 100; j++)
                {
                    m_decor[j][i].icon = ((Worlds.GetDecorField(lines, "Decor", j, i)) != null ? (Worlds.GetDecorField(lines, "Decor", j, i)) : -1);
                }
            }
            for (int k = 0; k < 100; k++)
            {
                for (int l = 0; l < 100; l++)
                {
                    m_bigDecor[l][k].icon = ((Worlds.GetDecorField(lines, "BigDecor", l, k)) != null ? (Worlds.GetDecorField(lines, "BigDecor", l, k)) : -1);
                }
            }
            for (int m = 0; m < MAXMOVEOBJECT; m++)
            {
        ...
        public boolean Read(int gamer, int rank, boolean bUser)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                for (int j = 0; j < 100; j++)
                {
                    m_decor[j][i].icon = ((Worlds.GetDecorField(array, "Decor", j, i)) != null ? (Worlds.GetDecorField(array, "Decor", j, i)) : -1);
                }
            }
            for (int k = 0; k < 100; k++)
            {
                for (int l = 0; l < 100; l++)
                {
                    m_bigDecor[l][k].icon = ((Worlds.GetDecorField(array, "BigDecor", l, k)) != null ? (Worlds.GetDecorField(array, "BigDecor", l, k)) : -1);
                }
            }
            for (int m = 0; m < MAXMOVEOBJECT; m++)
            {
        ...
        private boolean SearchWorld(int world, TinyPoint blupi, int[] dir)
        {
            if (world < 0 || world > 12)
            {
                return false;
            ...
            if (m_mission == 1)
            {
                for (int i = 0; i < 20; i++)
                {
                    if (SearchGold(i, cel) && (m_doors[180 + i] == 1 || m_bCheatDoors))
                    {
                        ...
                        m_moveObject[num].posCurrent = m_moveObject[num].posStart.Copy();
